...
from Controllers.DocumentController import addDocument, downloadDocument, viewDocument, updateDocument, replaceDocument, deleteDocument
...
async def updateDocFile(doc_id:str, file: UploadFile = File(...), new_name: str = Form(None)):
    return await replaceDocument(doc_id, file=file, new_name=new_name)
